...
export default function Block6 () {
  const handlePlayDuelsClick = () => {
    window.open('https://farcaster.xyz/miniapps/j20ZrzExJEXM/duels', '_blank')
  }
    ...
    <div>
      ...
      <div className="mt-16 md:mt-24">
        <h2 className="font-bold text-4xl md:text-8xl px-8 md:px-28 text-center">
          Apps like <a href="https://farcaster.xyz/miniapps/j20ZrzExJEXM/duels" target="_blank" rel="noopener noreferrer" className="underline underline-offset-[12px] hover:no-underline">Duels ⚔️</a> are driving novel onchain experiences
        </h2>
